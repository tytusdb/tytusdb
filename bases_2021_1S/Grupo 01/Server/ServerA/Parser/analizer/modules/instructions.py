from Parser.analizer.statement.instructions import delete
from Parser.analizer.statement.instructions import insert
from Parser.analizer.statement.instructions import update
from Parser.analizer.statement.instructions import truncate
from Parser.analizer.statement.instructions import show
from Parser.analizer.statement.instructions import assignment
from Parser.analizer.statement.instructions.drop import drop_table
from Parser.analizer.statement.instructions.drop import drop_index
from Parser.analizer.statement.instructions.alter import alter_data_base
from Parser.analizer.statement.instructions.alter import alter_table
from Parser.analizer.statement.instructions.alter import alter_index
from Parser.analizer.statement.instructions.create import create_data_base
from Parser.analizer.statement.instructions.create import create_table
from Parser.analizer.statement.instructions.create import create_type
from Parser.analizer.statement.instructions.select import select
from Parser.analizer.statement.instructions.select import from_
from Parser.analizer.statement.instructions.select import where
from Parser.analizer.statement.instructions.select import limit
from Parser.analizer.statement.instructions.select import orderby
from Parser.analizer.statement.instructions.select import operators
from Parser.analizer.statement.instructions.create import create_index
