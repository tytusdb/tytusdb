...
from routes.analizer.libs import MathFunctions as mf
from routes.analizer.libs import TrigonometricFunctions as trf
from routes.analizer.libs import StringFunctions as strf
