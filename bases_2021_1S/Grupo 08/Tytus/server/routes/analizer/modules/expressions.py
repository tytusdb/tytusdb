...
# Identificadores
from routes.analizer.statement.expressions import identifiers

# Operaciones unarias
from routes.analizer.statement.operations.unary import arithmetic as UnaryArithmetic
from routes.analizer.statement.operations.unary import relational as UnaryRelational
from routes.analizer.statement.operations.unary import logical as UnaryLogical
from routes.analizer.statement.operations.unary import existRelational
from routes.analizer.statement.operations.unary import inRelational

# Operaciones binarias
from routes.analizer.statement.operations.binary import arithmetic as BinaryArithmetic
from routes.analizer.statement.operations.binary import logical as BinaryLogical
from routes.analizer.statement.operations.binary import relational as BinaryRelational
from routes.analizer.statement.operations.binary import string as BinaryString

# Operaciones ternarias
from routes.analizer.statement.operations.ternary import relational as TernaryRelational

# Funcion Extract
from routes.analizer.statement.functions import extract
from routes.analizer.statement.functions import call
from routes.analizer.statement.functions import aggregate
from routes.analizer.statement.functions import check
from routes.analizer.statement.functions import current
from routes.analizer.statement.functions import part


from routes.analizer.statement.expressions import tablle_all
