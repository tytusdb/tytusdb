from routes.analizer.statement.instructions import delete
from routes.analizer.statement.instructions import insert
from routes.analizer.statement.instructions import update
from routes.analizer.statement.instructions import truncate
from routes.analizer.statement.instructions import show
from routes.analizer.statement.instructions import assignment
from routes.analizer.statement.instructions.drop import drop_table
from routes.analizer.statement.instructions.drop import drop_index
from routes.analizer.statement.instructions.alter import alter_data_base
from routes.analizer.statement.instructions.alter import alter_table
from routes.analizer.statement.instructions.alter import alter_index
from routes.analizer.statement.instructions.create import create_data_base
from routes.analizer.statement.instructions.create import create_table
from routes.analizer.statement.instructions.create import create_type
from routes.analizer.statement.instructions.select import select
from routes.analizer.statement.instructions.select import from_
from routes.analizer.statement.instructions.select import where
from routes.analizer.statement.instructions.select import limit
from routes.analizer.statement.instructions.select import orderby
from routes.analizer.statement.instructions.select import operators
from routes.analizer.statement.instructions.create import create_index
