from  Fase1.analizer.statement.instructions import delete
from  Fase1.analizer.statement.instructions import insert
from  Fase1.analizer.statement.instructions import update
from  Fase1.analizer.statement.instructions import drop
from  Fase1.analizer.statement.instructions import truncate
from  Fase1.analizer.statement.instructions import show
from  Fase1.analizer.statement.instructions.create import create_data_base
from  Fase1.analizer.statement.instructions.create import create_table
from  Fase1.analizer.statement.instructions.create import create_type
from  Fase1.analizer.statement.instructions.alter import alter_data_base
from  Fase1.analizer.statement.instructions.alter import alter_table
from  Fase1.analizer.statement.instructions import assignment
from  Fase1.analizer.statement.instructions.select import select
from  Fase1.analizer.statement.instructions.select import from_
from  Fase1.analizer.statement.instructions.select import where
from  Fase1.analizer.statement.instructions.select import limit
from  Fase1.analizer.statement.instructions.select import orderby
from  Fase1.analizer.statement.instructions.select import operators
