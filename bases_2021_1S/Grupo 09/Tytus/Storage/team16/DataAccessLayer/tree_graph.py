...
class TreeGraph:
    ...
    def export(self):
        ...
        temporal += 'node [shape= circle, style= filled, fontname="Century Gothic", color="#006400", fillcolor="#90EE90"]; \n'
        temporal += 'edge[color="#145A32"]'
        temporal += "label= <<font color=\"white\">\"  AVL de '" + self.title + "' \" </font>> fontname=\"Century Gothic\" \n"
        self.__prepare()
        temporal += self.content
        temporal += '\n}'
        #archivo.write()
        #archivo.close()
