from team29.analizer.statement.instructions import delete
from team29.analizer.statement.instructions import insert
from team29.analizer.statement.instructions import update
from team29.analizer.statement.instructions import truncate
from team29.analizer.statement.instructions import show
from team29.analizer.statement.instructions import assignment
from team29.analizer.statement.instructions.drop import drop_table
from team29.analizer.statement.instructions.drop import drop_index
from team29.analizer.statement.instructions.alter import alter_data_base
from team29.analizer.statement.instructions.alter import alter_table
from team29.analizer.statement.instructions.alter import alter_index
from team29.analizer.statement.instructions.create import create_data_base
from team29.analizer.statement.instructions.create import create_table
from team29.analizer.statement.instructions.create import create_type
from team29.analizer.statement.instructions.select import select
from team29.analizer.statement.instructions.select import from_
from team29.analizer.statement.instructions.select import where
from team29.analizer.statement.instructions.select import limit
from team29.analizer.statement.instructions.select import orderby
from team29.analizer.statement.instructions.select import operators
from team29.analizer.statement.instructions.create import create_index
