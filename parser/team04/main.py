...
def openFile():
    try:
        text = filedialog.askopenfilename(initialdir="C:/", title="Open Text File",filetypes=(("Text Files","*.txt"), ))
        text = open(text, 'r')
        stuff = text.read()
...
entrada = scrolledtext.ScrolledText(win, 
									wrap = tk.WORD, 
									width = 85, 
									height = 9, 
...
salida = scrolledtext.ScrolledText(win, 
									wrap = tk.WORD, 
									width = 85, 
									height = 10, 
									font = ("Times New Roman", 
