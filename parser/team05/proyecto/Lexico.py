...
def p_Inicio1(t):
    ...
    #REDUCE A INSTRUCCIONES 
    t[0]=t[1]

def p_Instruccion(t):
    'INSTRUCCION  :   I_SELECT COMPLEMENTOSELECT  '
    #CREA UN SELECT COMPLETO
