...
def abrirERRORES(): 
    erro_path = "C:\\Users\\mads3\\Documents\\GitHub\\tytus\\parser\\team11\\Errores.html"
    webbrowser.get('opera').open(erro_path)
# _____________________________________________INTERFAZ----------------------------------------------------
def abrirTS(): 
    ts_path = "C:\\Users\\mads3\\Documents\\GitHub\\tytus\\parser\\team11\\repoteTS.html"
    webbrowser.get('opera').open(ts_path)

def abritSVG():
    svg_path = "C:\\Users\\mads3\\Documents\\GitHub\\tytus\\parser\\team11\\ast.dot.svg"
