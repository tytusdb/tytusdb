...
def p_decla14(t):
    ...
    global columna
    t[0] = Declaracion(t[1],False,None,None,False,t[2],lexer.lineno,columna)
    varGramatical.append('pldecla ::= ID plasig')
    varSemantico.append('pldecla = Declaracion(ID,False,None,None,False,plasing)')
