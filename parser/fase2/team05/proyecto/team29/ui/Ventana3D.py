...
def main3d():
    global lista
    t0 = "create or replace database prueba1;"
    lista = [t0]
    funcionIntermedia()
    t1 = "use prueba1;"
    lista = [t1]
    funcionIntermedia()
    t2 = "create table tabla1 ( id INTEGER primary key ,valor INTEGER );"
    lista = [t2]
    funcionIntermedia()
    t3 = "insert into tabla1 values (  1,13255);"
    lista = [t3]
    funcionIntermedia()
    t4 = "insert into tabla1 values (  2,13256);"
    lista = [t4]
    funcionIntermedia()
