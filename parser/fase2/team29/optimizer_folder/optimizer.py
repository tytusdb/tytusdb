        ...
        while i < len(self.fuente):
            ...
            if actual.type==Quadruple.T_ASIG:
                if actual.resultado.id==actual.Elem1.id:
                    ...
                    self.registro.append(actual.resultado.id+"="+actual.Elem1.id+" -> Eliminacion")
                    del self.fuente[i]
            i += 1
                ...
                if actual.type == Quadruple.T_ARITOP:
                    if actual.operador == self.OP_DIVISION:
                        ...
                        if(actual.Elem2.id=="1"):
                            ...
                            self.registro.append(actual.resultado.id+"="+actual.Elem1.id+"/"+actual.Elem2.id+" -> "+nuevo.resultado.id+"="+nuevo.Elem1.id)
                        ...
                        #x=y*2=y+y or 2*y=y+y
                            ...
                            if actual.Elem1.id == "2":
                                if actual.Elem2.id.isalnum():
                                    ...
                                    self.registro.append(actual.resultado.id+"="+actual.Elem1.id+"*"+actual.Elem2.id+" -> "+nuevo.resultado.id+"="+nuevo.Elem1.id+"+"+nuevo.Elem2.id)
                ...
                while j < len(self.fuente):
                    ...
                    if actual.type == Quadruple.T_ASIG:
                        if actual.resultado.id == pivote.Elem1.id and actual.Elem1.id == pivote.resultado.id:
                            ...
                            self.registro.append(pivote.resultado.id+"="+pivote.Elem1.id+"\n#"+actual.resultado.id+"="+actual.Elem1.id+" \n # -> "+pivote.resultado.id+"="+pivote.Elem1.id)
                            del self.fuente[j]
                            j+=1
                        else:
                            j=len(self.fuente)
        ...
        while i < len(self.fuente):
            ...
            if pivote.type == Quadruple.T_GOTO:
                ...
                while j < len(self.fuente):
                    ...
                    if actual.type == Quadruple.T_LABEL or actual.type == Quadruple.T_LABEL_CASE:
                        if pivote.resultado.id == actual.resultado.id:
                            ...
                            j=len(self.fuente)
                    elif actual.type ==Quadruple.T_GOTO or actual.type==Quadruple.T_GOTO_CASE:
                        #goto .label
    ...
    def optimization_if_jump(self):
        ...
        while i < len(self.fuente):
            ...
            if pivote.type == Quadruple.T_IF:
                self.registro.append("Linea: "+str(pivote.line))
