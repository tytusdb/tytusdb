...
if __name__ == '__main__':
	...
	j.insert('world', 'countries', ['acronimo,2,,1,0,,,,,,1,,','name,2,,0,0,,,,,,0,,','region,2,,0,0,,,,,,0,,', 'code,0,,0,0,,,,,,0,,,'])

	j.insert('world', 'countries', ['GTM', 'Guatemala', 'Central America', 108889])
	j.insert('world', 'countries', ['SLV', 'El Salvador', 'Central America', 21041])
	...
	'''
	    ...
	    null,     						Setea si es nulo : activado= 1	
	  	...
	  	check:expression,               aun por definir
	'''


	'''
		create type area as ENUM ('100', '200')	
