...
vnoremap <silent> \ +: exe "resize". (winheight (0) * 3/2) 
onoremap <silent> \ +: exe "resize". (winheight (0) * 3/2) 
nmap \r :NERDTreeFocus | R | 
nmap \qf <Plug>(coc-fix-current)
nmap \ac <Plug>(coc-codeaction)
nnoremap <silent> \1 :source ~/.vimrc | :PluginInstall
noremap \t :term
noremap \w :w
vnoremap c "_c
nnoremap c "_c
...
silent only
silent tabonly
cd ~/Documentos/2S2020VACAS/Compi2/Fase2
...
wincmd w
argglobal
terminal ++curwin ++cols=137 ++rows=7 
...
exe '2resize ' . ((&lines * 7 + 21) / 42)
tabnext 1
badd +2 ui/PantallaPrincipal.py
badd +50 storage/storageManager/jsonMode.py
