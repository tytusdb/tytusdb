...
class Function_Cosd(Expresion):
    ...
    def execute(self, enviroment):
        ...
        if exp.tipo.data_type == Data_Type.numeric :
            ...
            try:
                ...
                self.valorExpresion = math.cos(valueExp * (math.pi / 180) ) 
    ...
    def compile(self, enviroment):
        ...
        self.cod = valueExp
        self.cod += self.dir + ' = math.cos(' + exp.dir + ' * (math.pi / 180))\n'
        return self.cod
    
    def getText(self):
        exp = self.hijos[0]
        stringReturn = 'cosd('+ exp.getText() +')'
        return stringReturn