...
class Function_Asind(Expresion):
    ...
    def execute(self, enviroment):
        ...
        if exp.tipo.data_type == Data_Type.numeric :
            ...
            try:
                ...
                self.valorExpresion = math.asin(valueExp) * ( 180. / math.pi )
    ...
    def compile(self, enviroment):
        ...
        self.cod = valueExp
        self.cod += self.dir + ' = math.asin(' + exp.dir + ') * ( 180. / math.pi )\n'
        return self.cod
    
    def getText(self):
        exp = self.hijos[0]
        stringReturn = 'asind('+ exp.getText() +')'
        return stringReturn