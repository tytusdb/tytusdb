...
class Function_Sind(Expresion):
    ...
    def execute(self, enviroment):
        ...
        if exp.tipo.data_type == Data_Type.numeric :
            ...
            try:
                ...
                self.valorExpresion = math.sin(valueExp * (math.pi / 180))
    ...
    def compile(self, enviroment):
        ...
        self.cod = valueExp
        self.cod = self.dir + ' = math.sin(' + exp.dir + '*(math.pi / 180))\n'
        return self.cod
    
    def getText(self):
        exp = self.hijos[0]
        stringReturn = 'sind('+ exp.getText() +')'
        return stringReturn