        ...
        if opname1 in ("LOAD_GLOBAL", "LOAD_NAME"):
            if opname2 == "LOAD_ATTR" and opname3 == "POP_TOP":
                ...
                if name == "label":
                    ...
                    gotos.append((offset1, offset4, oparg2, tuple(block_stack)))
        elif opname1 in (
            "SETUP_LOOP",
            "SETUP_EXCEPT",
            "SETUP_FINALLY",
...
def _patch_code(code):
    ...
    for pos, end, label, origin_stack in gotos:
        ...
        try:
            ...
            pos = _write_instruction(
                buf, pos, "JUMP_ABSOLUTE", target // _BYTECODE.jump_unit
            )
