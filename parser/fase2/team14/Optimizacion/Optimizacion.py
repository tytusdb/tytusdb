...
def p_IF(t):
    ''' CONDICIONIF : if EXP dospuntos delimitadores SALTO ETIQUETA
    '''
    vector=t[2]
    t[0]=CondicionIF(vector[0],vector[1],vector[2],t[5],t[6],t.lexer.lineno).Optimizar()
    print("IFS")
def p_IF1(t):
    ''' CONDICIONIF : if EXP dospuntos delimitadores SALTO 
    '''
    vector=t[2]
    t[0]=CondicionIF(vector[0],vector[1],vector[2],t[5],'',t.lexer.lineno).Optimizar()
    print("IFS")


def p_delimitadores(t):
    '''delimitadores : delimitadores nueval
                      | nueval
    '''
def p_ASIGNACION(t):
