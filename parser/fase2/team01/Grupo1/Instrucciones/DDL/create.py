...
class Create(Instruccion):
    ...
    def __init__(self, arg0,arg1,type, name, list):
        self.arg0 = arg0
        self.arg1 = arg1
        self.type = type
        self.name = name
    ...
    def execute(self, data):
        if self.type == 'type' :
            ...
            valRetorno = createDatabaseC3D(description.id.upper())            
            ...
            if valRetorno == 0:
                ...
                return 'Se ha creado el C3D para crear base de datos ' + description.id.upper() + ' correctamente.'
            elif valRetorno == 1:
                #return 'Error(42P12): invalid_database_definition.'
                return 'Ocurrio un error al generar el C3D para la creacion de base de datos.' + description.id.upper() 
            elif valRetorno == 2:
