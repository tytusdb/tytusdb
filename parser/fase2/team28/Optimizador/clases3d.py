        ...
        if isinstance(self.value, ArithmeticBinaryOperation):
            ...
            if self.id == opIzq:
                ...
                if isinstance(opDer, int) or isinstance(opDer, float) and isinstance(opIzq, str):
                        ...
                        if operador == "+" and opDer == 0:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                            OptimizationController().add(codigo_viejo, f'{idAss} = {opIzq}', "Regla 12")
                        elif operador == "*" and opDer == 1:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                            OptimizationController().add(codigo_viejo, f'{idAss} = {opIzq}', "Regla 14")
                        elif operador == "-" and opDer == 0:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                            OptimizationController().add(codigo_viejo, f'{idAss} = {opIzq}', "Regla 13")
                        elif operador == "/" and opDer == 1:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                            OptimizationController().add(codigo_viejo, f'{idAss} = {opIzq}', "Regla 15")
                        elif operador == "*" and opDer == 2:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                            OptimizationController().add(codigo_viejo, f'{idAss} = {opIzq} + {opIzq}', "Regla 16")
                        elif operador == "*" and opDer == 0:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                        ...
                        if operador == "+" and opIzq == 0:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                            OptimizationController().add(codigo_viejo, f'{idAss} = {opDer}', "Regla 12")
                        elif operador == "*" and opIzq == 1:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                            OptimizationController().add(codigo_viejo, f'{idAss} = {opDer}', "Regla 14")
                        elif operador == "*" and opIzq == 2:
                            codigo_viejo = f'{idAss} = {opIzq} {operador} {opDer}'
                            OptimizationController().add(codigo_viejo, f'{idAss} = {opDer} + {opDer}', "Regla 16")
