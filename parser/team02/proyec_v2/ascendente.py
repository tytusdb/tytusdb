...
def p_instrucciones_lista(t) :
    ...
    #gramatical = N.Agregar_grafo('instrucciones -> instrucciones instruccion','instrucciones.lista = instrucciones1.lista; </hr> instrucciones.lista.add(instruccion);',[])
   # Glist(2,gramatical)#func(0,gramatical)
...
def p_valores(t) :
    'valores    : valores COMA expresion_num '
    t[1].append(t[3])
    t[0] = t[1]

def p_valores2(t) :
    '''valores      : expresion_num                       
                        '''
    t[0] = [t[1]]
...
def p_creartable(t) :
    ...
    t[0] = Label(t[3],t[5],t.slice[1].lineno,find_column(t.slice[1]),t.slice[2].type)
def p_creartable9(t) :
...
def p_valorz(t):
    ...
    elif(t.slice[1].type == 'MD5'):
        l.Value_md5(Valor(str(t[3] ) ,t.slice[3].lineno,find_column(t.slice[3])))
