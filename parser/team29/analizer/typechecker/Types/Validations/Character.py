...
def validateVarchar(n, val):
    if 0 <= len(val) and len(val) <= n:
        return None
    syntaxPostgreErrors("Error: 22026: Excede el limite de caracteres")
...
def validateChar(n, val):
    if len(val) == n:
        return None
    syntaxPostgreErrors("Error: 22026: Restriccion de caracteres")
...
def validateBoolean(val):
    ...
    if s == "true" or s == "false":
        ...
        return None
    syntaxPostgreErrors("Error: 22000: Tipo invalido (Boolean)")
