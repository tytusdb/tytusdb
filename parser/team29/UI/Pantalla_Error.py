...
class Pantalla_Error():
   ...
   def __init__(self, parent,lexical,sintactic, semantic):
      ...
      self.tablaErroresLexicos = ttk.Treeview(frame,yscrollcommand=tabla_scroll.set,height=5)
     ...
     #Creacion del frame
      ...
      #Creacion de la tabla
      self.tablaErroresSintacticos = ttk.Treeview(frame2,yscrollcommand=tabla_scroll2.set,height=5)
      ...
      #Creacion de la tabla
      self.tablaErroresSemanticos = ttk.Treeview(frame3,yscrollcommand=tabla_scroll3.set,height=5)
