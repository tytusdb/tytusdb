...
class Pantalla():
    ...
    def inicializarScreen(self):
        ...
        self.tabla = ttk.Treeview(self.frame,yscrollcommand=self.tabla_scroll.set,xscrollcommand=self.tabla_scrollX.set,height=12)
    ...
    def fill_table(self,columns,rows): #funcion que muestra la salida de la/s consulta/s
