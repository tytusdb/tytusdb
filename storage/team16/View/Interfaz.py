from tkinter import Label, Frame, Button, Tk, TOP, RIGHT, LEFT, END, BOTH, CENTER, X, Y, W, SW, Scrollbar, Listbox, Grid, Entry, filedialog, messagebox
...
class GUI(Frame):
    ...
    def __init__(self, master = None, val = 0):
        ...
        self.val = val
        self.parametros = []
        self.master.title("Estructuras de Datos - TytusDB")
...
#Menu principal
    def agregarComp(self):
        ...
        self.btn2 = Button(self.master, text="Usar funciones", bg="#ffffff", activebackground="#85929e", font="Arial 18", pady=12, width=14, command= lambda: self.ventanaFunciones())
        self.btn2.pack(side=TOP, pady=(80,55))

        self.btn3 = Button(self.master, text="Ver reporte", bg="#ffffff", activebackground="#85929e", font="Arial 18", pady=12, width=14, command= lambda: self.ventanaReporte())
        self.btn3.pack(side=TOP, pady=(0,55))

        self.btnSalir = Button(self.master, text="Salir", bg="#ffffff", activebackground="#85929e", font="Arial 18", pady=12, width=14, command=exit)
        self.btnSalir.pack(side=TOP, pady=(0,55))
    

#Ventana de funciones
    def agregarComp2(self):
        self.titulo2 = Label(self.master, text="Funciones de TytusDB", bg="#5d6d7e", font=("Century Gothic", 42), pady=2)
        self.titulo2.grid(row=0, column=0, sticky='ew', columnspan=3, pady=(0,0))
        
        lbl1 = Label(self.master, text="Bases de datos", font=("Century Gothic", 21), bg="#0059b3")
        lbl1.grid(row=1, column=0, padx=(55,150), pady=(18,25))

        lbl2 = Label(self.master, text="Tablas", font=("Century Gothic", 21), bg="#0059b3")
        lbl2.grid(row=1, column=1, padx=(65,150), pady=(18,25))

        lbl3 = Label(self.master, text="Tuplas", font=("Century Gothic", 21), bg="#0059b3")
        lbl3.grid(row=1, column=2, padx=(120,150), pady=(18,25))    
    ...
    #Tablas
        btnCreateTb = Button(self.master, 
                            ...
                            bg="#abb2b9", font=("Courier New", 14), 
                            borderwidth=0.5, pady=6, width=16, 
                            command = lambda: self.simpleDialog(["database","tableName","numberColumns"],"Create table"))
        ...
        btnAlterDrop = Button(self.master, 
                            ...
                            bg="#abb2b9", font=("Courier New", 14), 
                            borderwidth=0.5, pady=6, width=16, 
                            command = lambda: self.simpleDialog(["database","tableName","columnNumber"],"Alter drop"))
    ...
    #Tuplas:
        ...
        btnUpdateTp = Button(self.master,
                            ...
                            bg="#abb2b9", font=("Courier New", 14), 
                            borderwidth=0.5, pady=6, width=12, 
                            command = lambda: self.simpleDialog(["database","table","id","columnNumber","value"],"Actualizar valor"))
...
#Digitador
    def simpleDialog(self, params, fun):
        ...
        dim = len(params)
        for i in range(dim):
                Label(dialog, text=params[i]+":", bg="#abb2b9", font=("Century Gothic", 12)
        ...
        submit = Button(dialog, text="OK", bg="#abb2b9", 
...
#Ventana de reporte
    def agregarComp3(self):
        self.titulo3 = Label(self.master, text="Árbol AVL", bg="#5d6d7e", font=("Century Gothic", 42), pady=12)
        self.titulo3.pack(fill=X)
        
        self.scrollbar = Scrollbar(self.master)
        self.scrollbar.pack(side=RIGHT, fill=Y)
        self.listbox = Listbox(self.master, yscrollcommand=self.scrollbar.set, height=21, width= 20, bg="#ecf0f1", font=("Century Gothic", 12))
